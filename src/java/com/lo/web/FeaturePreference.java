...
public class FeaturePreference {
	...
	private static final String NAMESPACE = "http://www.mapinfo.com/midev/service/feature/ws/v1";
	private static final String SERVICENAME = "FeatureService";
	private static final String DEFAULT_SERVICENAME = "http://" + HOST + ":" + PORT + "/soap/FeatureService/?wsdl";
	...
	public static FeatureServiceInterface getServiceInterface() throws Exception {
		FeatureService service;
		FeatureServiceInterface serviceInterface;
		service = new FeatureService(new URL(DEFAULT_SERVICENAME), new QName(NAMESPACE, SERVICENAME));
		serviceInterface = service.getFeatureServiceInterface();
...
//        Preference.setBasicAuthCredentials((BindingProvider) serviceInterface, USERNAME, PASSWORD);
	...
	public static void logout(FeatureServiceInterface serviceInterface) throws Exception {
