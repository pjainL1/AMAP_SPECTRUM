...
public class MappingPreference {
	...
	private static final String NAMESPACE = "http://www.mapinfo.com/midev/service/mapping/ws/v1";
	private static final String SERVICENAME = "MappingService";
	private static final String DEFAULT_SERVICENAME = "http://" + HOST + ":" + PORT + "/soap/MappingService/?wsdl";
	...
	public static MappingServiceInterface getServiceInterface() throws Exception {
		MappingService service;
		MappingServiceInterface serviceInterface;
		service = new MappingService(new URL(DEFAULT_SERVICENAME), new QName(NAMESPACE, SERVICENAME));

		serviceInterface = service.getMappingServiceInterface();
	...
	public static void logout(MappingServiceInterface serviceInterface) throws Exception {
